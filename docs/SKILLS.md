...
| Review a Plan | `ap-review-plan` | Has a fresh subagent challenge a plan each round. Critique-only on its own; edits the plan only when you ask or under an orchestrator. Requires subagents. | [Open skill](../content/packs/core/skills/engineering/workflows/planning/ap-review-plan/SKILL.md) |
